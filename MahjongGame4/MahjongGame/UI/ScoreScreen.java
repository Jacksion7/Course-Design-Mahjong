...
public class ScoreScreen extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawString(g, "Space Invaders Hall of Fame", new Rectangle(0, 0, Constant.SCREEN_WIDTH, Constant.SCREEN_HEIGHT / 8),
                36);
        ...
        for (int i = 0; i < scores.length; i++) {
            ...
            g.drawString(score.getName(), 2 * Constant.SCREEN_WIDTH / 6, 96 + i * 32);
            g.drawString("" + score.getScore(), 4 * Constant.SCREEN_WIDTH / 6, 96 + i * 32);
        }
